...
<body>
	...
	<table border="1" >
		<tr><td>제목</td>				<td><input type="text" name="atitle" value=" ${answer.atitle}" ></td></tr>
		<tr><td>질문 작성 번호 </td>	<td>${question.qcode}></td> <td>답변 작성 번호 </td><td style="width: 40px;"><input type="text" name="acode" value="${answer.acode}" readonly="readonly"></td></tr>
		...
		<p>답변 내용</p>
		<textarea style="width: 400px; height: 200px;" name ="acontent">${answer.acontent}</textarea><br/>
